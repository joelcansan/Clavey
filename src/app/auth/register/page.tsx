      ...
      <div style={{ background: 'var(--surface)', borderRadius: 24, padding: '40px 36px', width: '100%', maxWidth: 400, border: '1px solid var(--border)', boxShadow: 'var(--card-shadow)' }}>
        ...
        <form onSubmit={handleSubmit} noValidate style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            <label htmlFor="full_name" style={{ fontSize: 13, fontWeight: 600, color: 'var(--text-primary)' }}>Nombre completo</label>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            ...
            <input id="password" name="password" type="password" autoComplete="new-password" required placeholder="Mínimo 8 caracteres" disabled={isPending} aria-required="true"
              style={{ padding: '11px 14px', border: '1px solid var(--border-strong)', borderRadius: 12, fontSize: 15, color: 'var(--text-primary)', background: 'var(--input-bg)', outline: 'none', width: '100%' }} />
            <span style={{ fontSize: 12, color: 'var(--text-muted)' }}>Mínimo 8 caracteres</span>
          </div>
